...
var
    max_id_m: integer;
    max:integer = 0;
    time_ingot,pkdat,num,num_ingot,num_heat,name,weight_ingot,steel_group:string;
...
begin
        ...
        DataModule2.ib_query.SQL.Add('select i.pkdat,i.num,i.num_ingot,h.num_heat, s.name,i.weight_ingot, i.time_ingot, s.steel_group');
        DataModule2.ib_query.SQL.Add('from ingots i, heats h, steels s');
           ...
           if i = 1 then
              begin
                  break;
                    ...
                    Form1.Label7.Caption:=pkdat+'|'+num+'|'+num_ingot;
...
begin
        ...
        DataModule2.ib_query_view.SQL.Add('select i.pkdat,i.num,i.num_ingot,h.num_heat, s.name,i.weight_ingot, i.time_ingot, s.steel_group');
        DataModule2.ib_query_view.SQL.Add('from ingots i, heats h, steels s');
...
begin
        ...
        DataModule2.ib_query.Active:=false;
        DataModule2.ib_query.SQL.Clear;
        DataModule2.ib_query.SQL.Add('select i.pkdat,i.num,i.num_ingot,h.num_heat, s.name,i.weight_ingot, i.time_ingot, s.steel_group from ingots i, heats h, steels s');
